...
package net.ranjbar.trivialdrivesample;
...
import net.ranjbar.persianappstoreutils.IabBroadcastReceiver;
import net.ranjbar.persianappstoreutils.IabBroadcastReceiver.IabBroadcastListener;
import net.ranjbar.persianappstoreutils.IabHelper;
import net.ranjbar.persianappstoreutils.IabHelper.IabAsyncInProgressException;
...
public class MainActivity extends Activity implements IabBroadcastListener,
    ...
    static int[] TANK_RES_IDS = {net.ranjbar.trivialdrivesample.R.drawable.gas0, net.ranjbar.trivialdrivesample.R.drawable.gas1, net.ranjbar.trivialdrivesample.R.drawable.gas2,
            net.ranjbar.trivialdrivesample.R.drawable.gas3, net.ranjbar.trivialdrivesample.R.drawable.gas4};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(net.ranjbar.trivialdrivesample.R.layout.activity_main);
...
//        }
        ...
        mHelper = new IabHelper(this, base64EncodedPublicKey, persianStore.PACKAGE_CAFE_BAZAAR, persianStore.INTENT_CAFE_BAZAAR);
    ...
    public void onInfiniteGasButtonClicked(View arg0) {
        ...
        if (!mSubscribedToInfiniteGas || !mAutoRenewEnabled) {
            ...
            options[0] = getString(net.ranjbar.trivialdrivesample.R.string.subscription_period_monthly);
            options[1] = getString(net.ranjbar.trivialdrivesample.R.string.subscription_period_yearly);
            ...
            if (mInfiniteGasSku.equals(SKU_INFINITE_GAS_MONTHLY)) {
                ...
                options[0] = getString(net.ranjbar.trivialdrivesample.R.string.subscription_period_yearly);
        ...
        int titleResId;
        if (!mSubscribedToInfiniteGas) {
            titleResId = net.ranjbar.trivialdrivesample.R.string.subscription_period_prompt;
        } else if (!mAutoRenewEnabled) {
            titleResId = net.ranjbar.trivialdrivesample.R.string.subscription_resignup_prompt;
        } else {
            titleResId = net.ranjbar.trivialdrivesample.R.string.subscription_update_prompt;
        }

        Builder builder = new Builder(this);
        builder.setTitle(titleResId)
                .setSingleChoiceItems(options, 0 /* checkedItem */, this)
                .setPositiveButton(net.ranjbar.trivialdrivesample.R.string.subscription_prompt_continue, this)
                .setNegativeButton(net.ranjbar.trivialdrivesample.R.string.subscription_prompt_cancel, this);
    ...
    public void updateUi() {
        ...
        ((ImageView) findViewById(net.ranjbar.trivialdrivesample.R.id.free_or_premium)).setImageResource(mIsPremium ? net.ranjbar.trivialdrivesample.R.drawable.premium : net.ranjbar.trivialdrivesample.R.drawable.free);

        // "Upgrade" button is only visible if the user is not premium
        findViewById(net.ranjbar.trivialdrivesample.R.id.upgrade_button).setVisibility(mIsPremium ? View.GONE : View.VISIBLE);

        ImageView infiniteGasButton = (ImageView) findViewById(net.ranjbar.trivialdrivesample.R.id.infinite_gas_button);
        if (mSubscribedToInfiniteGas) {
            // If subscription is active, show "Manage Infinite Gas"
            infiniteGasButton.setImageResource(net.ranjbar.trivialdrivesample.R.drawable.manage_infinite_gas);
        } else {
            // The user does not have infinite gas, show "Get Infinite Gas"
            infiniteGasButton.setImageResource(net.ranjbar.trivialdrivesample.R.drawable.get_infinite_gas);
        }

        // update gas gauge to reflect tank status
        if (mSubscribedToInfiniteGas) {
            ((ImageView) findViewById(net.ranjbar.trivialdrivesample.R.id.gas_gauge)).setImageResource(net.ranjbar.trivialdrivesample.R.drawable.gas_inf);
        } else {
            int index = mTank >= TANK_RES_IDS.length ? TANK_RES_IDS.length - 1 : mTank;
            ((ImageView) findViewById(net.ranjbar.trivialdrivesample.R.id.gas_gauge)).setImageResource(TANK_RES_IDS[index]);
        }
    }

    // Enables or disables the "please wait" screen.
    void setWaitScreen(boolean set) {
        findViewById(net.ranjbar.trivialdrivesample.R.id.screen_main).setVisibility(set ? View.GONE : View.VISIBLE);
        findViewById(net.ranjbar.trivialdrivesample.R.id.screen_wait).setVisibility(set ? View.VISIBLE : View.GONE);
    }
