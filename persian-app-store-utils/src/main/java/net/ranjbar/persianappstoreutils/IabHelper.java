...
public class IabHelper {
    ...
    public IabHelper(Context ctx, String base64PublicKey,
        ...
        PACKAGE_NAME = store;
        PACKAGE_INTENT = intent;
        logDebug("کلاس پرداخت درون برنامه ای ساخته شد");
    }
    ...
    /**
     * فعال یا غیر فعال سازی دیباگ خودکار در لاگ کت
     */
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        mServiceConn = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                if (!PACKAGE_NAME.equals(name.getPackageName())) {
                    Log.d(mDebugTag, "target package authenticity is not confirmed. Exiting...");
                    return;
                } else {
        ...
        Intent serviceIntent = new Intent(PACKAGE_INTENT);
